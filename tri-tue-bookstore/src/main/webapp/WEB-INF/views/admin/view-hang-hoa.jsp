				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<div class="col-xs-12 bg-white progress_summary">
							...
							<div class="row">
								<div class="progress_title">
									<span class="left">WAN access users</span> <span class="right">Total
										69%</span>
									<div class="clearfix"></div>
								</div>
					...
					<div class="x_content">
						<div class="dashboard-widget-content">
							...
							<div class="sidebar-widget">
								...
								<div class="goal-wrapper">
									<span class="gauge-value pull-left">$</span> <span
										id="gauge-text2" class="gauge-value pull-left">3,200</span> <span
										id="goal-text2" class="goal-value pull-right">$5,000</span>
								</div>
							</div>
						</div>
					</div>
